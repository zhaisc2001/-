...
import urllib.request,http.cookiejar,urllib.parse,json,time,base64,re
...
class music:
    ...
    def get_hotcomments(self, url):
        ...
        f = open('/Users/violet/Documents/Spider教学/comments.txt', 'a', encoding='utf-8')
...
# mail = music()
# mail.get_hotcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_1403435714?csrf_token")
# mail.get_allcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_227323?csrf_token")

url = 'https://music.163.com/playlist?id=2273366323'
rsp = urllib.request.urlopen(url)
html = rsp.read().decode()

hrefs = re.findall('<a href=\"/song\?id=(.+?)\">',html)
for i in hrefs:
    try:
        mail = music()
        mail.get_hotcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_"+i+"?csrf_token")
        print("已爬取",(hrefs.index(i)+1)/len(hrefs)*100,"%")
